...
class MetallistProApp:
    ...
    def update_weld_joint_types(self):
        ...
        joints = {
            ...
            "Раздел II. Сварка трубопроводов": [
                "C2 (Стыковое без скоса)",
                "C8 (Стыковое со скосом одной кромки)",
                "C17 (Стыковое со скосом двух кромок)",
                "C18 (Стыковое на съемной подкладке)",
                "C5 (Стыковое на остающейся подкладке)",
                "C10 (Стыковое горизонтальное на подкладке)",
                "C19 (Стыковое на остающейся подкладке)",
                "C52 (Стыковое криволинейное)",
                "C53 (Стыковое криволинейное)",
    ...
    def build_weld_params(self):
        ...
        if "Раздел I" in section:
            ...
            if "C2" in joint_upper or "C8" in joint_upper or "C17" in joint_upper or "C" in joint_upper:
                params = [
                ...
                # Другие соединения (фланцы, патрубки)
                params = [
                    ("Толщина стенки S, мм", "4"),
                    ("Диаметр трубы D, мм", "57"),
                    ("Количество стыков n", "1")
    ...
    def calc_weld_by_sbornik(self):
        ...
        try:
            ...
            if "C2" in joint_upper:
                ...
                if "C2" in joint_upper or "C8" in joint_upper:
